        ...
        $(document).ready(function () {
            ...
            $(".editBtn").click(function (e) {
                ...
                try{
                    ...
                    $("#editModal [name='description']").val(d.description);
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                    <h5 class="text-muted vb">Total Number of Units</h5> </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-danger">{{ count(App\Site::get_records('units')) }}</h3> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                            ...
                            <a class="btn btn-default" data-toggle="modal" href="#addModal">+ Add New Unit</a>
                            <br>                           
                            <br> 
